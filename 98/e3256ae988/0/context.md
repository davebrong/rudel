...
The only issue, is that the image is not pasted to X post automatically

### Prompt 29

The toast is not visible at all, too fast interaction and too little in the bottom hahaha

### Prompt 30

This is awful, can we add the toast from before, wait a few seconds and open x?

### Prompt 31

Can we add some padding for the screenshot? Its kinda weird, since theres no space on the borders. This needs to be applied only in the screenshot

### Prompt 32

[Image: source: /Users/alvaro/Downloads/rudel-multi-dimensional-analysis-2026-03-12T19-33-35.png]

[Image: source: /Users/alvaro/Downloads/rudel-multi-dimensional-analysis-2026-03-12T19-33-35.png]

### Prompt 33

It should be applied on every side, not its applied only on the left I think

### Prompt 34

Look at this, looks weird

### Prompt 35

[Image: source: /Users/alvaro/Downloads/rudel-multi-dimensional-analysis-2026-03-12T19-37-49.png]
...
[Image: source: /Users/alvaro/Downloads/rudel-multi-dimensional-analysis-2026-03-12T19-38-40.png]

### Prompt 38

It works now, update the PR
